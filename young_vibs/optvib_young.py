...
#   print("Initial energy : ", energy, " eV")
   #
   dynamics = BFGS(atoms, trajectory='ZnO.traj', restart='qn.pckl')  #Put optimisation back in
...
#Vibrations
   ...
   vib.run()
   vib.summary(log='vibrations_summary.txt')
   #Write the last mode to the trajectory file
   vib.write_mode(-1)

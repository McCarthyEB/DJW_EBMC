...
#i cons_new = FixBondLength( index_1, index_2 )
#
if not cons_orig:
...
calc.set(istart=0, prec='Accurate', lreal='.FALSE.', lmaxmix=6, ediff=1E-8, encut=500)
#
atoms.set_calculator(calc)
e=atoms.get_potential_energy()  # Run the calculation
...
# Turn on spin then redo the energy
calc.set(istart=0, ispin=2, amix=0.4, amin=0.1, bmix=1.0, amix_mag=1.6, bmix_mag=1.0)
atoms.set_calculator(calc)
e=atoms.get_potential_energy()  # Run the calculation

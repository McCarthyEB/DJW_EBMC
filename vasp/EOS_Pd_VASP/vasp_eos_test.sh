#!/bin/bash --login
#SBATCH -o Pd_bulk.o        # Job output file
#SBATCH -e Pd_bulk.e        # Job error file
#SBATCH -J Pd_expt_eos          # Job name
...
export CODE="VASP"
MACHINE='hawk'
ASE_SCRIPT='spin_cell_scale_VASP.py'
struct_list="Pd_bulk"
CORES_PER_TASK=40
#
struct_name="POSCAR_expt"

...
#
cell_file = sys.argv[1]                                           # Directory where we will do the calculations
splstr=cell_file.split('.')
stem=splstr[0]
cif_file="%s.cif" % stem
#
print(f"------------------------------------------------------------")
print(f"cell file to convert         : %s" % cell_file )
print(f"Stem                         : %s" % stem     )
print(f"Will write cif file          : %s" % cif_file )
print(f"------------------------------------------------------------")
#
atoms=read(cell_file)

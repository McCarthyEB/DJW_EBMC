...
matches = list(sub_analyzer.calculate(film=Pd,substrate=ZnO))
...
cib = CoherentInterfaceBuilder (film_structure=Pd,
...
for cib_val in cib_list:
    interfaces=list(cib.get_interfaces(termination= (cib_val), film_thickness=2, substrate_thickness=2.5))

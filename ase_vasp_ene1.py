...
print(f"start time: %10.6f" % start_time)
...
time1 = time.time()
delt = time1-start_time
print(f"That took: %10.6f seconds" % delt )
#
# Turn lreal FALSE                         
calc.set(lreal='.FALSE.')
atoms.set_calculator(calc)
e=atoms.get_potential_energy()  # Run the calculation
print(f"Energy LREAL FALSE  = %10.6f eV" % e )
...
atoms.set_calculator(calc)
e=atoms.get_potential_energy()  # Run the calculation
print(f"Energy LREAL FALSE LMAXMIX 6  = %10.6f eV" % e )
...
#
# Try spin........                          
calc.set(ispin=2, amix=0.4, amin=0.1, bmix=1.0, amix_mag=1.6, bmix_mag=1.0)
atoms.set_calculator(calc)
e=atoms.get_potential_energy()  # Run the calculation
print(f"Energy LREAL FALSE LMAXMIX 6 ISPIN 2 = %10.6f eV" % e )
